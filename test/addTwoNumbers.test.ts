...
import { ListNode, addTwoNumbers } from '../src/addTwoNumbers/typescript.ts'
import { ListNode as ListNodeJs, addTwoNumbers as addTwoNumbersJs } from '../src/addTwoNumbers/javascript.js'
